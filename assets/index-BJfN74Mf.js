...
`,Og=({dimension:a="m",inverse:i=!1,svgMixin:u,...c})=>w.jsx(z2,{$dimension:a,$svgMixin:u,role:"alert","aria-live":"assertive",...c,children:w.jsx($g,{$inverse:i})});Og.displayName="Spinner";const or=a=>!!a&&(a.offsetHeight<a.scrollHeight||a.offsetWidth<a.scrollWidth),Dg=h.createContext(null),Bg=()=>h.useContext(Dg),H2=({children:a,...i})=>w.jsx(Dg.Provider,{value:i,children:a}),j2=h.createContext(null),Rg=()=>h.useContext(j2),ur=35,d0=4,Lf=V`
...
`,yE=a=>({Low:"neutral",Medium:"warning",High:"danger"})[a],bE=Y.div`
  ...
  flex-wrap: wrap;
  gap: 8px;
`,xE=({task:a})=>{const i=df();return w.jsxs(Qg,{maxWidth:"350px",children:[w.jsx(cr,{font:"Subtitle/Subtitle 1",children:a.title}),a.description&&w.jsx(cr,{font:"Body/Body 2 Long",children:a.description}),w.jsxs(bE,{children:[w.jsx(lu,{kind:"success",children:a.status}),w.jsx(lu,{kind:"primary",children:a.category}),w.jsx(lu,{kind:yE(a.priority),children:a.priority})]}),w.jsx(ir,{dimension:"s",appearance:"secondary",onClick:()=>i(`/task/${a.id}`),style:{marginTop:"auto"},children:"Редактировать"})]})},SE=Y.div`
  display: flex;
  flex-wrap: wrap;
  gap: 24px;
  justify-content: center;
...
`,_E=Y.div`
  ...
  box-sizing: border-box;
  border: 1px solid #d1d4d6;
`,TE=()=>{const{tasks:a}=Xg(),[i,u]=h.useState(!1),[c,s]=h.useState({status:"All",category:"All",priority:"All"}),d=(v,m)=>{s(y=>({...y,[v]:m}))},g=()=>{s({status:"All",category:"All",priority:"All"})},b=h.useMemo(()=>$E(a,c),[a,c]);return w.jsxs(cf,{children:[w.jsxs(NE,{children:[w.jsx(wE,{font:"Header/H1",children:"Менеджер задач"}),w.jsx(ir,{appearance:"primary",dimension:"s",onClick:()=>u(v=>!v),children:i?"Скрыть фильтры":"Фильтры"})]}),i&&w.jsxs(_E,{children:[w.jsx(In,{label:"Статус",value:c.status,options:Fg,onChange:v=>d("status",v),allowAll:!0}),w.jsx(In,{label:"Категория",value:c.category,options:Zg,onChange:v=>d("category",v),allowAll:!0}),w.jsx(In,{label:"Приоритет",value:c.priority,options:Kg,onChange:v=>d("priority",v),allowAll:!0}),w.jsx(ir,{appearance:"secondary",onClick:g,children:"Сбросить"})]}),w.jsx(EE,{tasks:b})]})},ME=Y.div`
  display: flex;
  gap: 16px;
  margin-top: 24px;
`,CE=Y.div`
  ...
  gap: 24px;
`,AE=({taskId:a})=>{const{getTaskById:i,updateTask:u}=Xg(),c=df(),[s,d]=h.useState(null);if(h.useEffect(()=>{const v=i(a);v?d(v):c("/")},[a,i,c]),!s)return w.jsx(cr,{font:"Main/L",children:"Загрузка..."});const g=(v,m)=>{d(y=>y?{...y,[v]:m}:null)},b=v=>{v.preventDefault(),s&&(u(s),c("/"))};return w.jsxs(Qg,{as:"form",onSubmit:b,padding:"40px",maxWidth:"1000px",children:[w.jsx(uf,{label:"Заголовок",value:s.title,onChange:v=>g("title",v.target.value),required:!0}),w.jsx(uf,{label:"Описание",placeholder:"Опишите задачу подробнее...",value:s.description,onChange:v=>g("description",v.target.value),style:{minHeight:"120px"}}),w.jsxs(CE,{children:[w.jsx(In,{label:"Статус",value:s.status,options:Fg,onChange:v=>g("status",v)}),w.jsx(In,{label:"Категория",value:s.category,options:Zg,onChange:v=>g("category",v)}),w.jsx(In,{label:"Приоритет",value:s.priority,options:Kg,onChange:v=>g("priority",v)})]}),w.jsxs(ME,{children:[w.jsx(ir,{type:"submit",appearance:"primary",disabled:!s.title.trim(),children:"Сохранить"}),w.jsx(ir,{type:"button",appearance:"secondary",onClick:()=>c("/"),children:"Отмена"})]})]})},OE=()=>{const{id:a}=U1();return a?w.jsx(cf,{children:w.jsx(AE,{taskId:a})}):w.jsx(cf,{children:w.jsx(cr,{font:"Header/H1",children:"Задача не найдена"})})};function DE(){return w.jsx(vE,{children:w.jsxs(eb,{children:[w.jsx(Us,{path:"/",element:w.jsx(TE,{})}),w.jsx(Us,{path:"/task/:id",element:w.jsx(OE,{})})]})})}u1.createRoot(document.getElementById("root")).render(w.jsx(jl.StrictMode,{children:w.jsx(Nb,{children:w.jsxs(Bx,{theme:vu,children:[w.jsx(pE,{}),w.jsx(DE,{})]})})}));
