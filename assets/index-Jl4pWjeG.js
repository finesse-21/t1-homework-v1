 ...
 */var hp;function e1(){if(hp)return hi;hp=1;var a=Symbol.for("react.transitional.element"),i=Symbol.for("react.fragment");function u(c,s,d){var g=null;if(d!==void 0&&(g=""+d),s.key!==void 0&&(g=""+s.key),"key"in s){d={};for(var b in s)b!=="key"&&(d[b]=s[b])}else d=s;return s=d.ref,{$$typeof:a,type:c,key:g,ref:s!==void 0?s:null,props:d}}return hi.Fragment=i,hi.jsx=u,hi.jsxs=u,hi}var mp;function t1(){return mp||(mp=1,ws.exports=e1()),ws.exports}var w=t1(),_s={exports:{}},be={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
...
`,Jx=Y(Nf)`
  ...
  flex-wrap: nowrap;
`,Ix=()=>null,wf=h.forwardRef(({targetElement:a,onClickOutside:i=Ix,className:u="",alignSelf:c,dropContainerCssMixin:s,...d},g)=>{const b=h.useRef(null),[v,m]=h.useState(!1),{rootRef:y}=h.useContext(bu);h.useLayoutEffect(()=>{b.current!==document.activeElement&&b?.current?.focus()},[]);const $=h.useCallback(()=>{const S=b.current;if(S&&a){const H=S.getBoundingClientRect(),B=a.getBoundingClientRect(),C=globalThis.innerHeight,D=globalThis.innerWidth,{upward:U,translateY:ee}=Zx(H,B,C);if(v!==U&&m(U),c&&c!=="auto")S.style.transform=`translateY(${ee})`;else{const{align:Z,translateX:W}=Fx(H,B,D);S.style.transform=`translate(${W}, ${ee})`,S.style.alignSelf=Z}}},[v,a]);Xx($,100),h.useEffect(()=>{b.current&&(b.current.style.opacity="1")},[]);const[x,T]=h.useState(!1);return h.useEffect(()=>{function S(){T(!0)}return document.addEventListener("mousedown",S,!0),document.addEventListener("touchstart",S,!0),()=>{document.removeEventListener("mousedown",S,!0),document.removeEventListener("touchstart",S,!0)}},[]),h.useEffect(()=>{function S(H){i(H)}if(x)return document.addEventListener("mouseup",S),document.addEventListener("touchend",S),()=>{document.removeEventListener("mouseup",S),document.removeEventListener("touchend",S)}},[x]),w.jsx(w.Fragment,{children:w.jsxs(Jx,{targetElement:a,$reverse:v,rootRef:y,onMouseDown:()=>T(!1),children:[w.jsx(Wx,{}),w.jsx(Kx,{ref:ea(g,b),...d,className:u+" dropdown-container",$alignSelf:c,$dropContainerCssMixin:s})]})})});wf.displayName="DropdownContainer";const eS=Y(wf)`
...
`;eS.displayName="StyledDropdownContainer";function tS(...a){return i=>a.forEach(u=>function(c,s){typeof c=="function"?c(s):c!=null&&(c.current=s)}(u,i))}function Ks(...a){return h.useCallback(tS(...a),a)}function _f(a){return h.forwardRef(a)}const Tf=V`
  overflow: scroll;
...
`,bS=a=>{a.preventDefault(),a.stopPropagation()},Mf=h.forwardRef(({children:a,expandIcon:i=w.jsx(yS,{}),hasSubmenu:u,onHover:c,disabled:s,readOnly:d,hovered:g,dimension:b="l",selected:v=!1,preselected:m=!1,selfRef:y,onMouseDown:$,onLeave:x,containerRef:T,...S},H)=>{const B=s?bS:$,C=y?ea(H,y):H;return w.jsxs(xS,{ref:C,$dimension:b,$preselected:m,$selected:v,$hovered:g,"data-preselected":m,"data-hovered":g,"data-disabled":s,"data-readonly":d,"data-dimension":b,onMouseEnter:D=>{c?.(D),S.onMouseEnter?.(D)},onMouseLeave:D=>{x?.(D),S.onMouseLeave?.(D)},onMouseMove:D=>{c?.(D),S.onMouseMove?.(D)},onMouseDown:B,...S,children:[h.Children.toArray(a).map((D,U)=>typeof D=="string"?w.jsx(SS,{children:D},D+U):D),u&&i]})});Mf.displayName="MenuItem";const xS=Y.div`
  display: flex;
  align-items: center;
  user-select: none;
  position: relative;
...
`,CS=Y.div`
  ...
  overflow: hidden;
  box-sizing: border-box;
`,Sg=({targetElement:a,children:i,onClickOutside:u,defaultRenderDirection:c="right",...s})=>{const{rootRef:d}=h.useContext(bu),g=h.useRef(null),[b,v]=h.useState(null),[m,y]=h.useState("row");h.useLayoutEffect(()=>{const[S,H]=$S(()=>{v({})},100);return addEventListener("resize",S),addEventListener("scroll",S),()=>{removeEventListener("resize",S),removeEventListener("scroll",S),H()}});const{addDropdown:$,removeDropdown:x,dropdowns:T}=gg(g);return h.useLayoutEffect(()=>($?.(g),()=>{x?.(g)}),[]),yg([g],S=>{a&&!a.contains(S.target)&&Qx(S,T)&&u?.(S)}),h.useLayoutEffect(()=>{const S=g.current;if(a&&S){const{position:H,bottomOffset:B=0}=NS(a,S,c);switch(H){case"right":y("row"),S.style.bottom=`${B}px`;break;case"left":y("row-reverse"),S.style.bottom=`${B}px`;break;case"rightBottom":default:y("row"),S.style.bottom="8px";break;case"leftBottom":y("row-reverse"),S.style.bottom="8px"}}},[a,b]),a&&w.jsx(wS,{children:w.jsxs(_S,{targetElement:a,rootRef:d,$flexDirection:m,fullContainerWidth:!1,children:[w.jsx(TS,{}),w.jsx(MS,{ref:g,...s,children:w.jsx(CS,{children:i})})]})})};Sg.displayName="SubMenu";const Eg=a=>{switch(a){case"l":default:return 48;case"m":return 40;case"s":return 32}},AS=V`
  max-height: ${({$dimension:a,$rowCount:i})=>{return`min(calc(100vh - 16px), ${u=i,c=a,Eg(c)*u+16}px)`;var u,c}};
`,OS=Y.div`
  overflow: hidden;
  position: relative;
...
`,JS=Y.div`
  ...
  ${WS}
  user-select: none;
`,Bf=h.forwardRef(({children:a,dimension:i="m",appearance:u="light",locale:c,...s},d)=>{const g=Ef()||vu,b=c?.amountAriaLabel||g.locales[g.currentLocale].badge.amountAriaLabel;return w.jsx(JS,{ref:d,$dimension:i,$appearance:u,"aria-label":`${b} ${a}`,...s,children:a})});Bf.displayName="Badge";Y(Bf)`
...
`,o0=Y.div`
  display: inline-block;
  width: 2px;
`,ir=h.forwardRef(({appearance:a="primary",dimension:i="xl",type:u="button",loading:c=!1,skeleton:s=!1,iconStart:d,iconEnd:g,icon:b,iconPlace:v="left",children:m,buttonCssMixin:y,displayAsDisabled:$,displayAsSquare:x,...T},S)=>{const H=!!d||!!b&&v==="left",B=!!g||!!b&&v==="right",C=(x||H?0:2)+(x||B?0:2);return w.jsxs(o2,{ref:S,$appearance:a,$dimension:i,type:u,$loading:c,$skeleton:s,$buttonCssMixin:y,$displayAsSquare:x,$displayAsDisabled:$,...T,children:[c&&w.jsx(i2,{children:w.jsx(Ng,{$inverse:a!=="secondary"&&a!=="tertiary"&&a!=="ghost"})}),!x&&!H&&w.jsx(o0,{}),w.jsxs(wg,{$addPadding:C,children:[H?w.jsx(rr,{children:d||b}):null,h.Children.toArray(m).map((D,U)=>typeof D=="string"?w.jsx("div",{children:D},D+U):D),B?w.jsx(rr,{children:g||b}):null]}),!x&&!B&&w.jsx(o0,{})]})}),o2=Y.button.attrs(a=>({"data-dimension":a.$dimension,"data-appearance":[a.$appearance,a.$displayAsDisabled?"disabled":void 0].filter(i=>i!==void 0).join(" ")}))`
  position: relative;
  box-sizing: border-box;
  display: inline-block;
  white-space: nowrap;
...
`,Cg=h.forwardRef(({className:a,dimension:i="m",disabled:u,readOnly:c,hovered:s,indeterminate:d,error:g,...b},v)=>w.jsxs(m2,{$dimension:i,$disabled:u,$readOnly:c,className:a,children:[w.jsx(y2,{ref:v,disabled:u,readOnly:c,...b,type:"checkbox",$indeterminate:d,onKeyDown:m=>{c&&P.getCode(m)===P[" "]&&m.preventDefault(),b.onKeyDown?.(m)},"data-hovered":s,$hovered:s}),w.jsx(sn,{$error:g,children:w.jsx(d?h2:d2,{"aria-hidden":"true",focusable:"false"})})]}));Cg.displayName="Checkbox";function Ci(){return(performance.now().toString(36)+Math.random().toString(36)).replace(/\./g,"")}const b2=V`
...
`;const x2=Y.div`
  ...
  overflow: hidden;
`,S2=({maxLength:a,visibilityThreshold:i=.8,inputRef:u,...c})=>{const[s,d]=h.useState(0);return h.useEffect(()=>{const g=setInterval(()=>{const b=u.current;b&&d(b.value.length)},250);return()=>clearInterval(g)},[u]),s>=a*i?w.jsxs(x2,{...c,$error:s>=a,$transparent:s<a*i,children:[s," / ",a]}):null},zf=Y.label`
  display: block;
  text-align: left;
  ...
  margin-bottom: 8px;
`;zf.displayName="Label";const Og=Y.div``,E2=V`
  flex-direction: row;
  align-items: center;
...
`,O2=Y(S2)`
  flex: 0 0 auto;
  padding: 8px 0 0 8px;
`,Hf=h.forwardRef(({children:a,maxLength:i,inputRef:u,displayCharacterCounter:c=!0,characterCounterVisibilityThreshold:s=.8,...d},g)=>{const b=h.useRef(null),[v,m]=h.useState(!1),{className:y,style:$,displayInline:x,status:T,extraText:S,label:H,required:B,disabled:C,id:D,skeleton:U=!1,...ee}=d,[Z]=h.useState(Ci()),W={className:y,style:$,...ee},I={htmlFor:D??Z,children:H,required:B,disabled:C};return h.useEffect(()=>{const fe=()=>{m(!0)},ne=()=>{m(!1)},me=b.current;return me&&(me.addEventListener("focusin",fe),me.addEventListener("focusout",ne)),()=>{me&&(me.removeEventListener("focusin",fe),me.removeEventListener("focusout",ne))}},[]),w.jsxs($2,{...W,$displayInline:x,"data-status":T,"data-focus-within":v?"":void 0,"data-required-within":B?"":void 0,"data-disabled":C?"":void 0,"data-read-only":!!d.readOnly||void 0,ref:ea(b,g),children:[I.children&&w.jsxs(w2,{children:[U&&w.jsx(N2,{}),w.jsx(T2,{$skeleton:U,...I})]}),w.jsxs(Og,{children:[a,w.jsxs(C2,{$skeleton:U,children:[S&&w.jsx(A2,{children:S}),c&&u&&i!==void 0&&w.jsxs(w.Fragment,{children:[w.jsx("div",{}),w.jsx(O2,{maxLength:i,visibilityThreshold:s,inputRef:u})]})]})]})]})});Hf.displayName="Field";function D2(a,i){return a.value!==i.value||a.selectionStart!==i.selectionStart||a.selectionEnd!==i.selectionEnd}function on(a,i){const{value:u=a.value,selectionStart:c,selectionEnd:s}=i;if(D2(a,{value:u,selectionStart:c,selectionEnd:s})){const d=Object.getOwnPropertyDescriptor(Object.getPrototypeOf(a),"value")?.set;let g;d?.call(a,u),typeof c=="number"&&typeof s=="number"&&a.setSelectionRange(c,s),typeof Event=="function"?g=new Event("input",{bubbles:!0}):(g=document.createEvent("Event"),g.initEvent("input",!0,!0)),a.dispatchEvent(g)}}function B2({icon:a,...i}){return w.jsx(a,{...i})}const jf=Y(B2)`
  & *[fill^='#'] {
    fill: var(--admiral-color-Neutral_Neutral50, ${a=>a.theme.color["Neutral/Neutral 50"]});
  }
  cursor: pointer;
...
`,Dg=({dimension:a="m",inverse:i=!1,svgMixin:u,...c})=>w.jsx(z2,{$dimension:a,$svgMixin:u,role:"alert","aria-live":"assertive",...c,children:w.jsx(Ng,{$inverse:i})});Dg.displayName="Spinner";const or=a=>!!a&&(a.offsetHeight<a.scrollHeight||a.offsetWidth<a.scrollWidth),Bg=h.createContext(null),Rg=()=>h.useContext(Bg),H2=({children:a,...i})=>w.jsx(Bg.Provider,{value:i,children:a}),j2=h.createContext(null),zg=()=>h.useContext(j2),ur=35,d0=4,Lf=V`
...
`,e6=()=>"",Uf=h.forwardRef(({dimension:a="m",disabled:i,appearance:u="outlined",selected:c,onClose:s,children:d,renderContentTooltip:g=e6,iconBefore:b,iconAfter:v,iconStart:m,iconEnd:y,badge:$,...x},T)=>{const S=c!==void 0,[H,B]=h.useState(!1),[C,D]=h.useState(!1),U=!!s,ee=!!$,Z=h.useMemo(()=>c&&!i?"whiteBlue":i?c||u==="filled"?"whiteDisable":"lightDisable":u==="filled"?"white":"info",[u,c,i]),W=h.useRef(null),I=h.useRef(null);return h.useEffect(()=>{I.current&&or(I.current)!==H&&B(or(I.current))},[C,B]),h.useLayoutEffect(()=>{function fe(){D(!0)}function ne(){D(!1)}const me=W.current;if(me)return me.addEventListener("mouseenter",fe),me.addEventListener("mouseleave",ne),me.addEventListener("focus",fe),me.addEventListener("blur",ne),()=>{me.removeEventListener("mouseenter",fe),me.removeEventListener("mouseleave",ne),me.removeEventListener("focus",fe),me.removeEventListener("blur",ne)}},[D]),w.jsxs(w.Fragment,{children:[w.jsx(Q2,{...x,ref:ea(T,W),$dimension:a,$disabled:i,$appearance:u,$selected:c,$defaultChip:S,$withCloseIcon:U,$withTooltip:H,$withBadge:ee,onKeyDown:fe=>{if(!i){const ne=P.getCode(fe);ne!==P.Enter&&ne!==P[" "]||(U?s?.():x.onClick?.(fe)),x.onKeyDown?.(fe)}},tabIndex:x.tabIndex??(i?-1:0),$clickable:!!x.onClick,children:w.jsxs(Z2,{$dimension:a,$disabled:i,$appearance:u,$selected:c,$withCloseIcon:U,children:[(m||b)&&w.jsx(K2,{children:w.jsx(h0,{$dimension:a,$withCloseIcon:U,children:m||b})}),w.jsx(F2,{ref:I,children:d}),$!==void 0&&w.jsx(J2,{"data-badge":!0,dimension:a,appearance:Z,children:$}),!s&&(y||v)&&w.jsx(W2,{$dimension:a,children:w.jsx(h0,{$dimension:a,$withCloseIcon:U,children:y||v})}),s&&w.jsx(I2,{dimension:a==="m"?"mBig":"s",highlightFocus:!1,onMouseDown:fe=>{fe.preventDefault(),s?.(x.id)},disabled:i,tabIndex:-1,appearance:u==="outlined"?"primary":"secondary"})]})}),C&&H&&w.jsx(Mi,{targetElement:W.current,renderContent:g})]})});Uf.displayName="Chips";const jg=Y.div`
  width: ${ur}px;
  height: 24px;
`,t6=Y.div`
  display: flex;
...
`,Fo=({value:a,disabled:i,renderChip:u,...c},s)=>{const d=u(),g={};return mr(c,g,"data",!1),(b=>typeof b=="object"&&b!==null&&!h.isValidElement(b))(d)?{...d,onClose:()=>d.onClose?.({value:a,disabled:i,...g})}:{disabled:i,onClose:()=>s(a),children:d}},m0=({className:a,option:i,disabled:u,readOnly:c,onClick:s,onChipRemove:d})=>{const g=h.useCallback(b=>()=>w.jsx(l6,{children:b}),[]);return w.jsx(r6,{className:a,tabIndex:-1,dimension:"s",appearance:"filled",onClick:s,onClose:c?void 0:Fo(i,d).onClose,disabled:Fo(i,d).disabled||u,renderContentTooltip:g(Fo(i,d).children),children:Fo(i,d).children})},i6=({count:a,disabled:i,onClick:u})=>{const c=h.useRef(null),s=h.useRef(null);return a?w.jsx(t6,{onClick:u,ref:c,className:"counter",children:w.jsxs(a6,{ref:s,"data-visible":!0,tabIndex:-1,dimension:"s",appearance:"filled",disabled:i,children:["+",a]})}):w.jsx(jg,{})},o6=Y.div`
  display: flex;
`,u6=h.forwardRef(({option:a,childrenOptions:i,containerRef:u,shouldShowCount:c,disabled:s,readOnly:d,onChipClick:g,onChipRemove:b},v)=>{const m=h.useRef(null),[y,$]=h.useState(!1);return h.useLayoutEffect(()=>{const x=new IntersectionObserver(function(T){if(T[0].isIntersecting&&!y){$(!0),T[0].target.setAttribute("data-visible","true");const S=T[0].target.previousElementSibling,H=T[0].target.nextElementSibling;return S&&S.removeAttribute("data-show-count"),void(H&&!H.getAttribute("data-visible")&&T[0].target.setAttribute("data-show-count",""))}if(y&&!T[0].isIntersecting){$(!1),T[0].target.removeAttribute("data-visible"),T[0].target.removeAttribute("data-show-count");const S=T[0].target.previousElementSibling;S&&S.getAttribute("data-visible")&&S.setAttribute("data-show-count","true")}},{root:u.current,threshold:[0,1]});return u.current&&m.current&&x.observe(m.current),()=>x.disconnect()},[y]),w.jsxs(o6,{ref:ea(v,m),onMouseDown:x=>x.preventDefault(),children:[w.jsx(m0,{className:"chip",option:a,disabled:s,readOnly:d,onClick:g,onChipRemove:b}),c&&i.length>0&&w.jsx(i6,{count:i.length,disabled:s,children:i.map(x=>w.jsx(m0,{option:x,disabled:s,readOnly:d,onClick:g,onChipRemove:b},x.value))}),!c&&w.jsx(jg,{})]},a.value)}),c6=({options:a,isOptionsListOpen:i,containerRef:u,hasMaxHeight:c,...s})=>{const d=Cf(i);return h.useEffect(()=>{c&&a.length!==0&&(d&&!i&&u.current?.scrollTo({top:0,left:0,behavior:"smooth"}),!d&&i&&setTimeout(()=>{u.current?.scrollTo({top:0,left:0,behavior:"instant"}),u.current?.scrollTo({top:u.current?.scrollHeight,left:0,behavior:"smooth"})}),i&&d&&u.current?.scrollTo({top:u.current?.scrollHeight,left:0,behavior:"smooth"}))},[i,a,c]),w.jsx(w.Fragment,{children:a.map((g,b)=>w.jsx(u6,{option:g,childrenOptions:b<a.length-1?a.slice(b+1):[],containerRef:u,...s},g.value))})},ol=Y.div`
  position: absolute;
  top: 0;
  bottom: 0;
  left: 0;
...
`,N6=({visibleValue:a,isSearchPanelOpen:i,targetRef:u,forceHideOverflowTooltip:c})=>{const s=h.useRef(null),[d,g]=h.useState(!1),[b,v]=h.useState(!1);h.useEffect(()=>{s.current&&or(s.current)!==d&&g(or(s.current))},[b,g]),h.useEffect(()=>{function y(){v(!0)}function $(){v(!1)}const x=s.current;if(x)return x.addEventListener("mouseenter",y),x.addEventListener("mouseleave",$),()=>{x.removeEventListener("mouseenter",y),x.removeEventListener("mouseleave",$)}},[v]);const m=!c&&!i&&b&&d;return w.jsxs(w.Fragment,{children:[w.jsx(d6,{ref:s,children:a}),m&&w.jsx(Mi,{renderContent:()=>a,targetElement:u.current})]})},w6=a=>a.stopPropagation(),_6=Y.select`
  ...
  border: none;
  pointer-events: none;
`,T6=h.forwardRef(({options:a,...i},u)=>{const c=h.useRef(null);return h.useEffect(()=>{function s(d){const g=P.getCode(d);g&&[P[" "],P.Enter,P.ArrowDown,P.ArrowUp].includes(g)&&d.preventDefault()}return c.current?.addEventListener("keydown",s),()=>c.current?.removeEventListener("keydown",s)},[]),w.jsxs(_6,{ref:ea(u,c),...i,onClick:w6,children:[w.jsx("option",{value:""}),a.map(s=>w.jsx("option",{value:s.value,disabled:s.disabled,children:s.value},s.value))]})}),kg=h.createContext(null),M6=()=>h.useContext(kg),C6=({children:a,...i})=>w.jsx(kg.Provider,{value:i,children:a}),A6=(a="",i="",u="wholly")=>{const c=(u==="word"?i.split(" "):[i]).filter(Boolean).map(b=>b.toLowerCase()),s=["[","]","\\","^","$",".","|","?","*","+","(",")"],d=c.map(b=>`(${b.split("").map(v=>s.includes(v)?`\\${v}`:v).join("")})?`).join(""),g=a.split(new RegExp(d,"gi")).filter(Boolean);return!i||g.some(b=>c.includes(b.toLowerCase()))},O6=Y.label`
  display: inline-flex;
...
`,R6=Y(Cg)`
  margin-top: 2px;
`,qg=h.forwardRef(({children:a,disabled:i=!1,readOnly:u=!1,hovered:c,dimension:s="m",error:d,indeterminate:g=!1,extraText:b,className:v,id:m,name:y,style:$,...x},T)=>{const S=h.useMemo(()=>m||Ci(),[m]),H={"data-field-id":S,"data-field-name":y};return $f(x,H),w.jsxs(O6,{className:v,$dimension:s,disabled:i,readOnly:u,style:$,...H,onClick:B=>{B.target.tagName!=="INPUT"&&B.stopPropagation()},children:[w.jsx(R6,{...x,ref:T,disabled:i,readOnly:u,type:"checkbox",indeterminate:g,onKeyDown:B=>{u&&P.getCode(B)===P[" "]&&B.preventDefault(),x.onKeyDown?.(B)},"data-hovered":c,hovered:c,dimension:s,id:S,name:y,error:d}),a&&w.jsxs(D6,{$dimension:s,disabled:i,children:[a,b&&w.jsx(B6,{disabled:i,$dimension:s,children:b})]})]})});qg.displayName="CheckboxField";Y(Ug)`
...
`;const z6=Y(qg)`
  margin-right: 8px;
  flex-shrink: 0;
`,H6=a=>Rg()?w.jsx(j6,{...a}):null,j6=({disabled:a=!1,id:i,value:u,children:c,renderOption:s,renderChip:d,...g})=>{const b=Rg(),v=zg(),m=v?.disabled||a,y=h.useCallback(()=>c,[c]),$=d||y,x=h.useMemo(()=>s?s({disabled:a}):c,[s,a,u,c]),T={};mr(g,T,"data",!1);const S=h.useMemo(()=>({id:i,value:u,disabled:m,children:x,renderChip:$,...T}),[i,u,m,x,$]);return h.useEffect(()=>(b?.onConstantOptionMount?.(S),()=>b?.onConstantOptionUnMount?.(S)),[b?.onConstantOptionMount,b?.onConstantOptionUnMount,S]),null},L6=({id:a,disabled:i=!1,readOnly:u=!1,value:c,children:s,renderOption:d,renderChip:g,...b})=>{const v=M6(),m=zg(),y=m?.disabled||i,$=x=>v?.multiple?(({selected:T=!1,hovered:S=!1})=>w.jsxs(w.Fragment,{children:[v?.showCheckbox&&w.jsx(z6,{checked:T,hovered:S,dimension:v?.dimension==="s"?"s":"m",disabled:i,onChange:()=>!1}),s]}))(x):s;return h.useEffect(()=>{const x=a||c,T={id:c,value:c,render:S=>{return d?d(S):h.createElement($6,{...S,dimension:(H=v?.dimension,H==="xl"?"l":H),key:x,...b,$selected:S.selected,$hovered:S.hovered,$preselected:S.preselected,$multiple:v?.multiple},$({selected:S.selected,hovered:S.hovered}));var H},disabled:y,readOnly:u};return v?.onDropDownOptionMount?.(T),()=>v?.onDropDownOptionUnMount?.(T)},[v?.onDropDownOptionMount,v?.onDropDownOptionUnMount,v?.dimension,v?.multiple]),null},p0=a=>w.jsxs(w.Fragment,{children:[w.jsx(H6,{...a}),w.jsx(L6,{...a})]}),U6=()=>h.useMemo(Ci,[]),k6=Y(Ug)`
  color: var(--admiral-color-Neutral_Neutral50, ${a=>a.theme.color["Neutral/Neutral 50"]});
`,g0=a=>a.stopPropagation(),v0=()=>{},Yg=h.forwardRef(({value:a,isLoading:i,className:u,style:c,status:s,icons:d,portalTargetRef:g,targetElement:b,inputTargetRef:v,disabled:m,readOnly:y,placeholder:$,defaultValue:x,dimension:T="m",idleHeight:S="fixed",minRowCount:H="none",maxRowCount:B="none",mode:C="select",multiple:D=!1,showCheckbox:U=!0,displayClearIcon:ee=!1,onClearIconClick:Z,onInputChange:W,inputValue:I,defaultInputValue:fe,renderSelectValue:ne,onFocus:me,onBlur:Pe,children:He,alignDropdown:We="stretch",alignSelf:vt="stretch",skeleton:Ae=!1,locale:L,dropContainerCssMixin:F,dropContainerClassName:ae,dropContainerStyle:J,renderDropDownTopPanel:E,renderDropDownBottomPanel:R,renderTopPanel:Q,renderBottomPanel:X,forcedOpen:te=!1,onChangeDropDownState:ue,onInputKeyDown:re,onInputKeyUp:Ye,onInputKeyUpCapture:ve,onInputKeyDownCapture:Je,searchFormat:Mt="wholly",onFilterItem:Ge=A6,virtualScroll:De,title:Rt,forceHideOverflowTooltip:Ta=!1,onSelectedChange:qa,moveSelectedOnTop:$t,clearInputValueAfterSelect:Xe=!0,openButtonPropsConfig:Lt=v0,clearButtonPropsConfig:zt=v0,...ht},ta)=>{const Ul=Ef()||vu,hn=L?.emptyMessage||w.jsx(k6,{$dimension:T,children:Ul.locales[Ul.currentLocale].select.emptyMessage}),[Ze,kl]=h.useState(a??x),[Ma,yt]=h.useState(""),Fe=I===void 0?Ma:I,[ot,ie]=h.useState(!1),[ge,pe]=h.useState(),[je,Ie]=h.useState([]),[Be,Gt]=h.useState([]),[_e,Vt]=h.useState(te),[Pt,aa]=h.useState(!1),[la,Ca]=h.useState(void 0),pr=a===void 0,na=C==="select",Ai=h.useMemo(()=>B!=="none"&&B>0?B:S==="fixed"?1:"none",[B,S])!=="none",mn=a??x,Aa=h.useRef(Array.isArray(mn)?mn:[]),ql=h.useRef(!1),va=h.useRef([]);h.useEffect(()=>{Array.isArray(a)&&(Aa.current=a)},[a]);const Oa=h.useMemo(()=>D?null:je.find(K=>K.value===Ze),[D,je,Ze]),et=h.useMemo(()=>D&&Array.isArray(Ze)?Ze.reduce((K,ce)=>{const ye=je.find(ct=>ct.value===ce);return ye&&K.push(ye),K},[]):[],[je,Ze,D]),Ct=Cf(_e),[ya,pn]=h.useState([]);h.useEffect(()=>{if(D&&$t||!(ya.length>0)||pn([]),D&&$t&&Ct!==_e&&_e){const K=et.map(ye=>ye.value),ce=K.length>0?K.reduce((ye,ct)=>{const mt=Be.find(ua=>ua.value===ct);return mt&&ye.push(mt),ye},[]):[];pn(ce)}},[Be,_e,et,D,$t]);const gr=h.useMemo(()=>{const K=ya.map(ye=>ye.value),ce=Be.filter(ye=>Ge(ye.value,Fe,Mt)).reduce((ye,ct)=>(K.includes(ct.value)||ye.push(ct),ye),[...ya]);return ce.length?ce:[{id:"emptyMessage",render:()=>w.jsx(E6,{children:hn},"empty"),disabled:!0}]},[i,Be,T,Fe,ya]);h.useEffect(()=>{ge&&(gr.find(K=>K.id===ge)||pe(void 0))},[gr,ge]);const ra=v??h.useRef(null),Ya=h.useRef(null),At=h.useRef(null),vr=b||g?.current||At.current,Ga=h.useRef(null),ia=h.useRef(null),Va=h.useRef({shouldExtendInputValue:!1}),sl=K=>{Ie(ce=>[...ce,K]),va.current.includes(K.value)&&(va.current=va.current.filter(ce=>ce!==K.value))},ut=K=>{Aa.current.includes(K.value)&&(va.current=[...va.current,K.value]),Ie(ce=>ce.filter(ye=>ye.value!==K.value))},Oi=h.useCallback(K=>{Gt(ce=>[...ce,K])},[]),Di=h.useCallback(K=>{Gt(ce=>ce.filter(ye=>ye.id!==K.id))},[]),ba=h.useCallback(()=>{Vt(!1),ra.current&&on(ra.current,{value:""}),ie(!0)},[Ze]),oa=h.useCallback(K=>{const ce=Ya.current;if(!ce)return;const ye=Array.from(ce.options),ct=ye.find(mt=>mt.value===K);if(ct&&(D||ye.forEach(mt=>mt.selected=!1),ct.selected=!D||!ct.selected,ce.dispatchEvent(new Event("change",{bubbles:!0})),D||ba(),Fe&&ra.current&&Xe)){on(ra.current,{value:"",selectionEnd:0,selectionStart:0});const mt=ge;pe(""),setTimeout(()=>pe(mt))}},[ba,D,Fe,ge]),xu=h.useCallback(()=>{const K=Ya.current;K&&(K.selectedIndex=-1,K.dispatchEvent(new Event("change",{bubbles:!0})))},[]);h.useEffect(()=>{te!==_e&&Vt(te)},[te]),h.useEffect(()=>{ue?.(_e),!_e&&Pt&&document.activeElement!==At.current&&Ya.current?.focus()},[_e,Pt]);const Bi=Z||xu,yr=Ai&&!_e,Su=h.useCallback(()=>w.jsx(c6,{containerRef:Ga,options:et,shouldShowCount:yr,disabled:m,readOnly:y,onChipRemove:oa,onChipClick:g0,isOptionsListOpen:_e,hasMaxHeight:!!B&&B!=="none"}),[et,yr,m,y,oa,_e,B]),fl=(D?!Ze?.length:!Ze)&&!!$&&!Fe,gn=ne?.(Ze,Fe),xa=Oa?.children,br=D?Su():xa,dl=gn||br||Ze||null,Sa=typeof dl=="string",xr=Sa?w.jsx(N6,{visibleValue:dl,isSearchPanelOpen:_e,targetRef:At,forceHideOverflowTooltip:Ta}):dl,vn=()=>{Vt(K=>!K)},Eu=()=>{if(!Fe&&Ze)return D?void(()=>{const K=(ce=[...et].reverse(),ce.find(({disabled:ye})=>!ye)?.value);var ce;K&&oa(K)})():ie(!1)};h.useEffect(()=>{if(!y&&!m)return At.current?.addEventListener("keydown",K),()=>{At.current?.removeEventListener("keydown",K)};function K(ce){const ye=P.getCode(ce);ye===P[" "]&&(!na&&Fe?ce.stopPropagation():_e||(ce.preventDefault(),Vt(!0),ce.stopPropagation())),ye!==P.Enter||_e||(ce.preventDefault(),Vt(!0),ce.stopPropagation()),ye!==P.ArrowDown&&ye!==P.ArrowUp||_e||(Vt(!0),ce.stopPropagation());const ct=ce.ctrlKey||ce.metaKey||ce.altKey;ce.key.length!==1||ct||Sa&&!Fe&&ot&&(Va.current.shouldExtendInputValue=!0),ye!==P.Backspace||ce.repeat||Eu(),ye===P.Backspace&&((mt=>{if(!Sa||!ra.current||Fe||!ot||!Ze)return;mt.preventDefault();const ua=dl.slice(0,-1);on(ra.current,{value:ua,selectionEnd:ua.length,selectionStart:ua.length})})(ce),Vt(!0)),ye===P.Escape&&_e&&(Vt(!1),ce.preventDefault(),ce.stopPropagation())}},[y,m,na,Fe,_e,et]),h.useEffect(()=>{function K(){ql.current=!1}return At.current?.addEventListener("keyup",K),()=>{At.current?.removeEventListener("keyup",K)}},[]),h.useEffect(()=>{(!Pt&&!D||D)&&(ra.current&&on(ra.current,{value:""}),ie(!0))},[D,Pt]),h.useEffect(()=>{_e&&(na?Ya.current?.focus():ra.current?.focus(),Ca(""))},[_e,na]),h.useEffect(()=>{la&&pe("")},[la]),h.useEffect(()=>{ge&&Ca("")},[ge]),h.useEffect(()=>{if(_e){const K=Ze&&!Array.isArray(Ze)?Ze:void 0;pe(K)}},[_e]),h.useEffect(()=>{pr||kl(a)},[a,pr]),yg([At,ia],K=>{K.target&&At.current?.contains(K.target)||(aa(!1),ba())});const Ri=ot&&(D?!!Ze?.length:!!Ze),Nt=h.useMemo(()=>h.Children.map(He,K=>h.isValidElement(K)?h.cloneElement(K,{key:Ci(),...K.props}):null),[He]),zi=h.useMemo(()=>w.jsx(C6,{onDropDownOptionMount:Oi,onDropDownOptionUnMount:Di,dimension:T,multiple:D,showCheckbox:U,children:Nt}),[Nt,T,U,D]),$u=h.useMemo(()=>w.jsx(H2,{onConstantOptionMount:sl,onConstantOptionUnMount:ut,children:Nt}),[Nt]),yn=Yx(ht),Hi=mg(ht),Yl={icon:Of,id:"searchSelectClearIcon",onClick:Bi,"aria-hidden":!0},ji={$isOpen:_e,onClick:vn,"aria-hidden":!0};return w.jsxs(b6,{className:u,style:c,$focused:Pt,$multiple:D,disabled:m,"data-disabled":m,$readonly:y,$isLoading:i,$dimension:T,ref:At,"data-status":s,onClick:m||y||i?void 0:K=>{K.target&&ia.current?.contains(K.target)||!na&&_e||vn()},onFocus:K=>{Pt||(aa(!0),me?.(K))},onMouseDown:K=>{Pt&&K.preventDefault()},$skeleton:Ae,onBlur:K=>{K.currentTarget.contains(K.relatedTarget)||ia.current?.contains(K.relatedTarget)||(aa(!1),Vt(!1),Ya.current?.blur(),Pe?.(K),ql.current=!1)},title:Rt,children:[$u,zi,w.jsx(T6,{ref:ea(ta,Ya),value:Ze,multiple:D,disabled:m,options:je,...ht,onChange:K=>{if(ql.current&&na)return void Ca(K.target.value);const ce=D?Array.from(K.target.selectedOptions).map(ct=>ct.value):K.target.value;let ye=[];if(D&&Array.isArray(ce)){const ct=ce.filter(Ea=>!Aa.current.includes(Ea)&&!va.current.includes(Ea)),mt=Aa.current.filter(Ea=>!ce.includes(Ea)&&!va.current.includes(Ea));ye=[...Aa.current,...ct];const ua=[...va.current];mt.forEach(Ea=>{const Pa=ye.findIndex(bn=>Ea===bn);Pa>-1&&ye.splice(Pa,1);const Li=ua.findIndex(bn=>Ea===bn);Li>-1&&ua.splice(Li,1)}),Aa.current=ye,va.current=ua}pr&&kl(D?ye:ce),ht.onChange?.(K),qa?.(D?ye:ce)}}),w.jsx(ol,{}),w.jsxs(Lg,{tabIndex:-1,ref:Ga,className:"selectValueWrapper",$dimension:T,$multiple:D,$minRowCount:H!=="none"?H:void 0,$maxRowCount:B!=="none"?B:void 0,$idleHeight:S,$opened:_e,$isEmpty:fl,children:[ot&&xr,($&&fl||!na)&&w.jsx(m6,{"data-id":ht.id,placeholder:fl?$:"",tabIndex:-1,ref:ra,disabled:m,readOnly:y||na,value:Fe,defaultValue:fe,$isMultiple:D,$dimension:T,onChange:K=>{D||ie(!1),(ce=>{Va.current.shouldExtendInputValue&&Sa&&(ce.target.value=`${dl}${ce.target.value}`,Va.current.shouldExtendInputValue=!1)})(K),I===void 0&&yt(K.target.value),W?.(K)},onKeyDown:re,onKeyUp:Ye,onKeyUpCapture:ve,onKeyDownCapture:Je})]}),_e&&!Ae&&w.jsx(wf,{ref:ia,tabIndex:-1,targetElement:vr,"data-dimension":T,alignSelf:We||vt,dropContainerCssMixin:F,className:ae,style:J,...yn,children:w.jsx(S6,{dimension:T==="xl"?"l":T,active:ge,selected:Ze,onActivateItem:K=>pe(K),onSelectItem:oa,onDeselectItem:oa,multiSelection:D,model:gr,renderTopPanel:E||Q,renderBottomPanel:R||X,containerRef:ia,virtualScroll:De,preventFocusSteal:!0,preselectedModeActive:na,preselected:la,onPreselectItem:Ca,onMenuKeyDown:()=>{ql.current=!0},...Hi})}),w.jsxs(y6,{$multiple:D,$dimension:T,onClick:g0,onMouseDown:K=>K.preventDefault(),children:[i&&w.jsx(Dg,{dimension:T==="s"?"ms":"m"}),ee&&!y&&Ri&&w.jsx(jf,{...Yl,...zt(Yl)}),d,!y&&w.jsx(Gx,{"data-disabled":!!m||void 0,"data-loading":!!i||void 0,...ji,...Lt(ji)})]})]})});Yg.displayName="Select";var y0;function rf(){return rf=Object.assign?Object.assign.bind():function(a){for(var i=1;i<arguments.length;i++){var u=arguments[i];for(var c in u)({}).hasOwnProperty.call(u,c)&&(a[c]=u[c])}return a},rf.apply(null,arguments)}var q6=function(a){return h.createElement("svg",rf({xmlns:"http://www.w3.org/2000/svg",fill:"none",viewBox:"0 0 24 24"},a),y0||(y0=h.createElement("path",{fill:"#74767B",fillRule:"evenodd",d:"M20.65 18c0 1.66-1.35 3-3 3h-8c-1.31 0-2.43-.84-2.84-2.01q-.36-.015-.69-.12a.65.65 0 0 1-.43-.81c.1-.35.46-.54.81-.44.05.02.1.03.15.04V8c0-1.66 1.34-3 3-3h7.16a1 1 0 0 0-.04-.15.64.64 0 0 1 .43-.81c.35-.11.71.09.81.43q.09.27.12.57A3 3 0 0 1 20.65 8zm-11 1.7h8c.93 0 1.7-.76 1.7-1.7V8c0-.94-.77-1.7-1.7-1.7h-8c-.94 0-1.71.76-1.71 1.7v10c0 .94.77 1.7 1.71 1.7m-4.28-3.2c.02.06.03.12.03.19a.647.647 0 0 1-1.27.18C4.04 16.6 4 16.3 4 16v-.95c0-.35.29-.65.65-.65.35 0 .65.3.65.65V16c0 .17.02.34.07.5m-.07-4.56c0 .36-.3.65-.65.65-.36 0-.65-.29-.65-.65v-1.89c0-.36.29-.65.65-.65.35 0 .65.29.65.65zm0-5c0 .36-.3.65-.65.65-.36 0-.65-.29-.65-.65v-.95c0-.36.05-.72.15-1.06.11-.34.47-.54.82-.43a.64.64 0 0 1 .43.81c-.07.21-.1.45-.1.68zm1.66-3.19c-.34.1-.71-.09-.81-.44a.6.6 0 0 1-.03-.19c0-.27.18-.53.46-.62.34-.1.7-.16 1.07-.16h.64c.36 0 .65.3.65.65 0 .36-.29.65-.65.65h-.64c-.24 0-.47.04-.69.11m9.06-1.27a.64.64 0 0 1 .43.81c-.1.34-.47.53-.81.43-.16-.05-.32-.08-.5-.08h-.77c-.36 0-.65-.29-.65-.65 0-.35.29-.65.65-.65h.77c.31 0 .6.05.88.14m-5.6 1.16c-.35 0-.65-.29-.65-.65 0-.35.3-.65.65-.65h1.42c.36 0 .65.3.65.65 0 .36-.29.65-.65.65z"})))};const of=a=>{switch(a.$dimension){case"xl":default:return 24;case"s":return 20}},kf=a=>{switch(a.$dimension){case"xl":return 16;case"m":default:return 8;case"s":return 6}},qf=a=>{switch(a.$dimension){case"xl":case"m":default:return 16;case"s":return 12}},Y6=V`
...
`;function F6(a){return a}const K6=a=>a.preventDefault(),js=(a,i)=>a*(i==="s"?20:24)+2*kf({$dimension:i}),W6=Y(Ag)`
...
`,sE=Y.span`
  ...
  ${a=>a.$skeleton&&cE}
`,cr=_f(({font:a,color:i,cssMixin:u,skeleton:c,...s},d)=>w.jsx(sE,{ref:d,...s,$font:a,$color:i,$cssMixin:u,$skeleton:c}));cr.displayName="T";const fE="/t1-homework-v1/assets/VTBGroupUI-SemiBold-Wupg3RVc.ttf",dE="/t1-homework-v1/assets/VTBGroupUI-Medium-CJW7SkqK.otf",hE="/t1-homework-v1/assets/VTBGroupUI-Regular-JWIonCWQ.otf",mE=`
    @font-face {
...
`;function pE(a){return w.jsx("style",{type:"text/css",children:mE,...a})}const gE=[{id:"1",title:"Сделать 1 домашнее задание в ИТ-Лагере",description:"Создать данный менеджер задач",category:"Bug",status:"To Do",priority:"High"},{id:"2",title:"Поучавствовать в 1 воркшопе",description:"Перед этим сделать 1 дз",category:"Feature",status:"In Progress",priority:"Medium"},{id:"3",title:"Пройти весь курс в лагере",description:"",category:"Documentation",status:"Done",priority:"Low"},{id:"4",title:"Написать 1 тест по frontend",category:"Test",status:"To Do",priority:"Medium"},{id:"5",title:"Пройти на стажировку в Т1",category:"Refactor",status:"In Progress",priority:"High"}],Xg=h.createContext(void 0),vE=({children:a})=>{const[i,u]=h.useState(gE),c=d=>{u(i.map(g=>g.id===d.id?d:g))},s=d=>i.find(g=>g.id===d);return w.jsx(Xg.Provider,{value:{tasks:i,updateTask:c,getTaskById:s},children:a})},Qg=()=>{const a=h.useContext(Xg);if(!a)throw new Error("useTasks must be used within a TaskProvider");return a},Zg=Y.div`
...
`,yE=a=>({Low:"neutral",Medium:"warning",High:"danger"})[a],bE=Y.div`
  ...
  flex-wrap: wrap;
  gap: 8px;
`,xE=({task:a})=>{const i=df();return w.jsxs(Zg,{maxWidth:"350px",children:[w.jsx(cr,{font:"Subtitle/Subtitle 1",children:a.title}),a.description&&w.jsx(cr,{font:"Body/Body 2 Long",children:a.description}),w.jsxs(bE,{children:[w.jsx(lu,{kind:"success",children:a.status}),w.jsx(lu,{kind:"primary",children:a.category}),w.jsx(lu,{kind:yE(a.priority),children:a.priority})]}),w.jsx(ir,{dimension:"s",appearance:"secondary",onClick:()=>i(`/task/${a.id}`),style:{marginTop:"auto"},children:"Редактировать"})]})},SE=Y.div`
  display: flex;
  flex-wrap: wrap;
  gap: 24px;
  justify-content: center;
  ...
  box-sizing: border-box;
  padding: 0 16px;
`,EE=({tasks:a})=>w.jsx(SE,{children:a.map(i=>w.jsx(xE,{task:i},i.id))}),cf=Y.div`
  display: flex;
  flex-direction: column;
  align-items: center;
  justify-content: flex-start; 
  ...
  box-sizing: border-box;
  margin: 0 auto;
`,In=({label:a,value:i,options:u,onChange:c,allowAll:s})=>w.jsxs(Pg,{label:a,value:i,onChange:d=>c(d.target.value),children:[s&&w.jsx(p0,{value:"All",children:"Все"}),u.map(d=>w.jsx(p0,{value:d,children:d},d))]}),Fg=["Bug","Feature","Documentation","Refactor","Test"],Kg=["To Do","In Progress","Done"],Wg=["Low","Medium","High"],$E=(a,i)=>a.filter(u=>{const c=i.status==="All"||u.status===i.status,s=i.category==="All"||u.category===i.category,d=i.priority==="All"||u.priority===i.priority;return c&&s&&d}),NE=Y.div`
  display: flex;
  justify-content: space-between;
  align-items: flex-start;
  width: 100%;
...
`,_E=Y.div`
  ...
  box-sizing: border-box;
  border: 1px solid #d1d4d6;
`,TE=()=>{const{tasks:a}=Qg(),[i,u]=h.useState(!1),[c,s]=h.useState({status:"All",category:"All",priority:"All"}),d=(v,m)=>{s(y=>({...y,[v]:m}))},g=()=>{s({status:"All",category:"All",priority:"All"})},b=h.useMemo(()=>$E(a,c),[a,c]);return w.jsxs(cf,{children:[w.jsxs(NE,{children:[w.jsx(wE,{font:"Header/H1",children:"Менеджер задач"}),w.jsx(ir,{appearance:"primary",dimension:"s",onClick:()=>u(v=>!v),children:i?"Скрыть фильтры":"Фильтры"})]}),i&&w.jsxs(_E,{children:[w.jsx(In,{label:"Статус",value:c.status,options:Kg,onChange:v=>d("status",v),allowAll:!0}),w.jsx(In,{label:"Категория",value:c.category,options:Fg,onChange:v=>d("category",v),allowAll:!0}),w.jsx(In,{label:"Приоритет",value:c.priority,options:Wg,onChange:v=>d("priority",v),allowAll:!0}),w.jsx(ir,{appearance:"secondary",onClick:g,children:"Сбросить"})]}),w.jsx(EE,{tasks:b})]})},ME=Y.div`
  display: flex;
  gap: 16px;
  margin-top: 24px;
`,CE=Y.div`
  ...
  gap: 24px;
`,AE=({taskId:a})=>{const{getTaskById:i,updateTask:u}=Qg(),c=df(),[s,d]=h.useState(null);if(h.useEffect(()=>{const v=i(a);v?d(v):c("/")},[a,i,c]),!s)return w.jsx(cr,{font:"Main/L",children:"Загрузка..."});const g=(v,m)=>{d(y=>y?{...y,[v]:m}:null)},b=v=>{v.preventDefault(),s&&(u(s),c("/"))};return w.jsxs(Zg,{as:"form",onSubmit:b,padding:"40px",maxWidth:"1000px",children:[w.jsx(uf,{label:"Заголовок",value:s.title,onChange:v=>g("title",v.target.value),required:!0}),w.jsx(uf,{label:"Описание",placeholder:"Опишите задачу подробнее...",value:s.description,onChange:v=>g("description",v.target.value),style:{minHeight:"120px"}}),w.jsxs(CE,{children:[w.jsx(In,{label:"Статус",value:s.status,options:Kg,onChange:v=>g("status",v)}),w.jsx(In,{label:"Категория",value:s.category,options:Fg,onChange:v=>g("category",v)}),w.jsx(In,{label:"Приоритет",value:s.priority,options:Wg,onChange:v=>g("priority",v)})]}),w.jsxs(ME,{children:[w.jsx(ir,{type:"submit",appearance:"primary",disabled:!s.title.trim(),children:"Сохранить"}),w.jsx(ir,{type:"button",appearance:"secondary",onClick:()=>c("/"),children:"Отмена"})]})]})},OE=()=>{const{id:a}=k1();return a?w.jsx(cf,{children:w.jsx(AE,{taskId:a})}):w.jsx(cf,{children:w.jsx(cr,{font:"Header/H1",children:"Задача не найдена"})})};function DE(){return w.jsx(j0,{basename:"/t1-homework-v1",children:w.jsx(vE,{children:w.jsxs(tb,{children:[w.jsx(Us,{path:"/",element:w.jsx(TE,{})}),w.jsx(Us,{path:"/task/:id",element:w.jsx(OE,{})})]})})})}c1.createRoot(document.getElementById("root")).render(w.jsx(jl.StrictMode,{children:w.jsx(j0,{children:w.jsxs(Bx,{theme:vu,children:[w.jsx(pE,{}),w.jsx(DE,{})]})})}));
